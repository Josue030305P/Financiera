        ...
        <div class="card-body">
            <form id="form-persona">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="numdocumento" name="numdocumento" placeholder="Número de Documento" maxlength="8" required>
                </div>
                <div class="input-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="telprincipal" name="telprincipal" placeholder="9XXXXXXXX" maxlength="9" required>
                </div>
                <div class="input-group full-width">
                    <label for="domicilio"><i class="fas fa-home"></i> Domicilio</label>
                    <input type="text" id="domicilio" name="domicilio" placeholder="Dirección completa" required>
                </div>
                <button type="submit" class="btn btn-primary full-width" id="crear-persona">Crear Persona</button>
            </form>
        </div>
    </div>
    ...
    <div class="card add-colaborador-card card-hidden">
        ...
        <div class="card-body">
            <form id="form-colaborador">
                ...
                <button type="submit" class="btn btn-success full-width" id="agregar-colaborador">Agregar Colaborador</button>
            </form>
        </div>
    </div>
    ...
    <div class="card add-usuario-login-card card-hidden">
        ...
        <div class="card-body">
            <form id="form-usuario-login">
                ...
                <button type="submit" class="btn btn-dark full-width" id="crear-usuario">Crear Usuario</button>
            </form>
        </div>
    </div>
</div>
