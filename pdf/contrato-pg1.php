  ...
  <page backtop="10mm" backbottom="10mm" backleft="10mm" backright="10mm">
    <div class="container">
      ...
      <p>
        ...
        <strong>YAGUILLO ALIAGA FRANCHESCA BRILLITTE</strong> identificado con <strong>DNI N°70781463</strong>, domicilio en <strong>MZ.D LT.3-C SECTOR EL CALICHE FUNDO COPACABANA</strong>, 
      ...
      <h4 class="text-left underline bold">SEGUNDA. - RENTABILIDAD</h4>
      ...
      <h4 class="text-left underline bold">TERCERA. - DEVOLUCIÓN DEL MUTUO Y RENTABILIDAD</h4>
      <p><strong>EL MUTUATARIO</strong> está obligado a devolver a <strong>EL MUTUANTE</strong> la suma del monto de capital invertido siendo de 
        <strong>S/65,000.00 (SESENTA Y CINCO MIL SOLES)</strong>, más la rentabilidad mensual en los plazos y en las fechas indicadas en el <strong>“Cronograma de Pago del Mutuatario al Mutuante”</strong>.
      </p>
    </div>
